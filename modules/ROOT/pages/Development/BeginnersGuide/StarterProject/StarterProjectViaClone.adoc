...
// needed for :archiveactionphrase:
include::../_includes/repo-versions.adoc[]

:verbphrase: clone
:verbphraseCaps: Clone
:actionphrase: .
:archiveactionphrase: the v{this-archive-version} tag.
...
so you may have to switch branches to the branch or tag you actually intended to clone.
...
Make sure you're on the branch/tag you intended before proceeding.
====
