...
Or, if you've already closed the popup,
// Make sure the below content stays in sync with Audio.adoc#_Unreal_Project_Configuration
open the Unreal Engine project settings (`Edit` > `Project Settings...`)
