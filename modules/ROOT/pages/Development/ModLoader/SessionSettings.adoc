...
Note that Session Settings do not require Advanced Game Settings to be enabled to be used.
...
Session settings are always per-game-save, while mod config is per game install.
