...
[IMPORTANT]
====
Are you a new Satisfactory mod developer who hasn't set up a modding environment yet?
Follow the xref:Development/BeginnersGuide/index.adoc[Getting Started Guide] instead.
====
