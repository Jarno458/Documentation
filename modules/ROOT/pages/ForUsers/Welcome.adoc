...
To use mods you will need to install the **Satisfactory Mod Manager (SMM)**, a tool that automatically takes care of all mod installation and configuration steps for you.
It's the best and quickest way to get started playing with mods.
Learn how to install and use it on the
...
You can browse the list of all available mods directly within the mod manager!
Make sure that your "Show" dropdown is set to "Compatible", ensuring that only known-working mods are displayed.
...
Some mods will provide a support link, such as a documentation site or a Discord join link.
